...
class Amazon:
    ...
    def handle_checkout(self, test):
        ...
        while True:
            try:
                # log.info(self.driver.find_element_by_id("wineNoticeCheckbox"))
                # if self.driver.find_element_by_id("wineNoticeCheckbox"):
                #     chkBox = self.driver.find_element_by_id("wineNoticeCheckbox")
                #     self.do_button_click(button=chkBox)
                # if chkBox:
                #     cntLoop = 0
                #     while True:
                #         if cntLoop > 10000:
